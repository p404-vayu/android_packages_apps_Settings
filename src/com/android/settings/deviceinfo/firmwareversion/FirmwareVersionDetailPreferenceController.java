...
public class FirmwareVersionDetailPreferenceController extends BasePreferenceController {
    ...
    @VisibleForTesting
    private static final String P404_PLATFORM_RELEASE_OR_CODENAME = "ro.p404.settings.android_version";
    ...
    public CharSequence getSummary() {
        return SystemProperties.get(P404_PLATFORM_RELEASE_OR_CODENAME, 
